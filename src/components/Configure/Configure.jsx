  ...
  return (
    <>
      <div style={{ display: snap.current ? "block" : "none" }}>
        ...
        />
        <div>
          <h1 style={{ fontFamily: "Clash Display", fontWeight: "500" }} className='item'>
            {snap.current}
          </h1>
        </div>
      </div>
      ...
      <Canvas camera={{ near: 0.01, far: 110, fov: 90 }} shadows flat>
        ...
        <Html style={{ fontFamily: "Clash Display" }} scale={0.5} position={[0, 2, 0]} transform occlude>
          <div className='annotation'>
            <span style={{ fontSize: "1.1rem", fontFamily: "Clash Display" }}>
              Click on the different parts of the Soundboks
            </span>
          </div>
        </Html>
